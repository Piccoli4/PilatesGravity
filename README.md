...
- **Pagos por administradora** — los superadministradores ven cuántos pagos cargó cada administradora y por qué monto, abiertos por forma de cobro (efectivo, transferencia, tarjeta, otro), con los anulados en una columna aparte. Se filtra por administradora, forma de pago, cliente y período (un día, una semana, un mes o un rango), tomando la fecha del pago o la fecha en que se cargó al sistema. Debajo del resumen va el detalle de cada pago, con link a la cuenta del cliente
